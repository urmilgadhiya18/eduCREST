...
// import { Upload, X, Plus, Save, Sun, Moon, Film, Clock, BookOpen } from 'lucide-react'
...
//   return (
//     <div className={`min-h-screen py-6 transition-colors duration-300 ${isDarkMode ? 'bg-gray-900 text-white' : 'bg-gray-100 text-gray-900'}`}>
//       <motion.div
//         initial={{ opacity: 0, y: -20 }}
//         animate={{ opacity: 1, y: 0 }}
//         transition={{ duration: 0.5 }}
