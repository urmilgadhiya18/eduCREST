...
// import Link from 'next/link'
// import { BookOpen, Users, BarChart, Settings, Menu, X } from 'lucide-react'
...
//             <Link href="/" className="text-2xl font-bold">EduCREST</Link>
...
//                 pathname === item.href ? 'bg-purple-800' : 'hover:bg-purple-600'
//               }`}
//             >
...
//             </button>
//             <div className="flex items-center">
//               <span className="text-gray-700 text-sm mr-4">Welcome, User</span>
//               <button className="bg-purple-600 text-white text-sm font-semibold py-2 px-4 rounded-full hover:bg-purple-700 transition duration-300">
//                 Sign Out
//               </button>
//             </div>
//           </div>
